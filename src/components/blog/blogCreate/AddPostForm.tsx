...
const EditPostForm = () => {
    ...
    return (
        ...
        >
            {/* Comentario: Se ajusta orden y ancho para que etiquetas aparezca primero en móvil */}
            ...
            {/* Comentario: Se ajusta orden y ancho para que el formulario vaya después en móvil */}
