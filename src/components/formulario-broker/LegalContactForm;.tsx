    ...
    return (
        <Box sx={{ widt: "100%", mx: "auto", p: 2, display: "flex", flexDirection: "column", gap: 4, m: 10 }}>
            <Box sx={{ display: "flex", gap: 2 }}>
                <Box sx={{ flex: 1 }}>
                    <Typography variant="body1" fontWeight="bold">NIT</Typography>
                    <TextField fullWidth variant="outlined" />
                </Box>
                <Box sx={{ flex: 1 }}>
                    <Typography variant="body1" fontWeight="bold">Nombre del Representante legal</Typography>
                    <TextField fullWidth variant="outlined" />
                </Box>
                <Box sx={{ flex: 1 }}>
                    <Typography variant="body1" fontWeight="bold">Número de teléfono del Rep. Legal</Typography>
                    <TextField fullWidth variant="outlined" />
                </Box>
            </Box>
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
                <Box sx={{ flex: 1 }}>
                    <Typography variant="body1" fontWeight="bold">Departamento de operación principal 22</Typography>
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
                <Box sx={{ flex: 1 }}>
                    <Typography variant="body1" fontWeight="bold">Nombre de contacto comercial</Typography>
                    <TextField fullWidth variant="outlined" />
                </Box>
                <Box sx={{ flex: 1 }}>
                    <Typography variant="body1" fontWeight="bold">Teléfono de contacto comercial</Typography>
                    <TextField fullWidth variant="outlined" />
                </Box>
            </Box>
                ...
                <Box sx={{ display: "flex", gap: 2 }}>
                    <ToggleButton
                        ...
                        sx={{
                            ...
                            px: 3,
                            py: 1,
                            minWidth: "60px", // tamaño mínimo para que no se vean muy pequeños
                        }}
                    >
                        Sí
                    </ToggleButton>
